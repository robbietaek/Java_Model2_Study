...
<tr><td colspan="2">
  <a href="replyForm.do?num=${b.num}&pageNum=${param.pageNum}">[답변]</a>
  <a href="updateForm.do?num=${b.num}&pageNum=${param.pageNum}">[수정]</a>
  <a href="deleteForm.do?num=${b.num}&pageNum=${param.pageNum}">[삭제]</a>
