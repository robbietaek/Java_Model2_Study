...
1부터100까지의 합: ${sum}<br>
<h3>forEach 태그를 이용하여 1부터 100까지의 짝수합 구하기 : 김정은</h3>
<c:forEach var="i" begin="0" end="100" step="2">
  <c:set var="evensum" value="${evensum+i}" />
</c:forEach>
1부터100까지의 짝수의 합: ${evensum}<br>
...
1부터100까지의 짝수의 합: ${sum}<br>
<h3>forEach 태그를 이용하여 1부터 100까지의 홀수합 구하기 : 김정은</h3>
<c:forEach var="i" begin="1" end="100" step="2">
  <c:set var="oddsum" value="${oddsum+i}" />
</c:forEach>
1부터100까지의 홀수의 합: ${oddsum}<br>
<c:set var="sum" value="${0}" />
<c:forEach var="i" begin="0" end="100">
  <c:if test="${i%2==1}">
      <c:set var="sum" value="${sum+i}" />
