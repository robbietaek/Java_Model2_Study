...
public class ControllerMethodServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String command = null;
		try {
//			System.out.println(request.getRequestURI());	//프로젝트를 제외한 요청 url : /model2/hello.do Key값으로 쓰이게 될 것이다.	
//			System.out.println(request.getContextPath());	//methodName : hello
